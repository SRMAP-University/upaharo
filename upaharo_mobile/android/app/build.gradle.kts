...
android {
    namespace = "com.upaharo.upaharo_mobile"
    ...
    buildTypes {
        release {
            // Prefer upload keystore when key.properties exists; otherwise debug (local only).
...
dependencies {
    ...
    // FlutterFire already pulls messaging; BOM keeps native Firebase aligned.
